    ...
    _createClass(T, [{
        ...
        value: function reciprocal() {
            if (this.y) {
                ...
                return new T((0, _div2.default)(this.x, d), (0, _div2.default)((0, _neg2.default)(this.y), d));
            }
            return new T((0, _div2.default)(1, this.x));
        }
    }, {
        key: 'fft',
        value: function fft() {
...
T.identity = function (n) {
    return new T((0, _identity2.default)(n));
};
